...
export EXAMPLE_DIR="${VESSEL_ROOT}/examples/gradle"
...
export BIN_FILE=$(get_manifest_value "bin_file" "$EXAMPLE_DIR/vessel.json")
export BIN_FILE_NAME="$(basename "$BIN_FILE")"
